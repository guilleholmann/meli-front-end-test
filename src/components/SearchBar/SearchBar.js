      ...
      <header className="app__header">
        <div className="app__nav app__container">
          ...
          <form className="nav__search-form" action="" method="GET" role="search">
            <input type="text" className="nav__search-input" aria-label="Ingresá lo que quieras encontrar" placeholder="Nunca dejes de buscar" maxLength="120" autoFocus="" autoCapitalize="off" autoCorrect="off" spellCheck="false" autoComplete="off" tabIndex="2"/>
